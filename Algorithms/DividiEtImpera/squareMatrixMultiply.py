...
def square_matrix_multiply_recursive(matrix_1, matrix_2):
    ...
    if n == 1:
        ...
        matrix_3[0][0] = square_matrix_multiply_recursive(matrix_1[0][0],matrix_2[0][0])
        + square_matrix_multiply_recursive(matrix_1[0][1],matrix_2[1][0])

        matrix_3[0][1] = square_matrix_multiply_recursive(matrix_1[0][0], matrix_2[0][1])
        + square_matrix_multiply_recursive(matrix_1[0][1], matrix_2[1][1])

        matrix_3[1][0] = square_matrix_multiply_recursive(matrix_1[1][0], matrix_2[0][0])
        + square_matrix_multiply_recursive(matrix_1[1][1], matrix_2[1][0])

        matrix_3[1][1] = square_matrix_multiply_recursive(matrix_1[1][0], matrix_2[0][1])
